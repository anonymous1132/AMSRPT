...
{
    public class DB2Oper
    {
        public DB2Oper(Db2ConnObj conn)
        {
            strConn = string.Format("Provider={0};Data Source={1};UID={2};PWD={3};",conn.Provider,conn.DataSource,conn.UID,conn.PWD);
        }
