...
{
    //copy by http://www.360doc.com/content/13/0905/20/1944636_312482651.shtml
    //date:2018.07.11
    ...
    public class XmlHelper
    {
        ...
        public static XmlDocument CreateXmlDocument(string name,string dataSource,string version)
        {
            XmlDocument doc = null;
            XmlElement rootEle = null;
            try
            {
                ...
                doc.LoadXml("<" + name + "/>");
                rootEle = doc.DocumentElement;
                rootEle.SetAttribute("DataSource",dataSource );
                rootEle.SetAttribute("FormatVersion",version);
            }
            catch (Exception er)
            {
                throw er;
        ...
        public static void Insert(ref XmlNode xn,string element,string attribute,string value)
        {
            ...
            {
                XmlElement xe = (xn.OwnerDocument).CreateElement(element);
                if (attribute.Equals(""))
                    xe.InnerText = value;
                else
                    xe.SetAttribute(attribute, value);
        ...
        public static void InsertAttribute(ref XmlNode xn,string attribute,string value)
        {
            Insert(ref xn,"",attribute,value);
        }

        public static void InsertElement(ref XmlNode xn,string element,string value)
        {
            Insert(ref xn,element,"",value);
        }
        /// <summary>
        /// 修改数据
        /// </summary>
